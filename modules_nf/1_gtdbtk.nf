...
process GTDB_FILTER {
    ...
    publishDir "${params.outdir}/01_gtdbtk", pattern: "gtdbtk_summary.tsv", mode: 'copy'
    publishDir "${params.outdir}/01_gtdbtk/filtered_genomes", pattern: "selected/*", mode: 'copy', saveAs: { filename -> filename.split('/').last() }
